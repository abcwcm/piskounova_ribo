...
cover_dir <- "/SSD/maa7095/RIBOseq/Shino_new_analysis/inframe_downtream_analysis/Cell_lines/p_site_coverage/"
  ...
  write.csv(new_df,paste0("/SSD/maa7095/RIBOseq/Shino_new_analysis/inframe_downtream_analysis/Cell_lines/p_site_coverage/CDF_plots/", condition,   "_by_groups/", gene_name,"_coverage_df.csv"), quote=F, row.names = F)
  
  new_df <- new_df %>%
    mutate(counts = ifelse(str_detect(Condition, "ko1"), -1 * counts, counts))
  
  
  pdf(file = paste0("/SSD/maa7095/RIBOseq/Shino_new_analysis/inframe_downtream_analysis/Cell_lines/p_site_coverage/CDF_plots/", condition, "_by_groups/",gene_name, "_coverage_clean_counts.pdf"),   # The directory you want to save the file in
      width = 10,
      height = 12) # 
  ...
  pdf(file = paste0("/SSD/maa7095/RIBOseq/Shino_new_analysis/inframe_downtream_analysis/Cell_lines/p_site_coverage/CDF_plots/", condition, "_by_groups/",gene_name, "_coverage.pdf"),   # The directory you want to save the file in
      width = 10,
      height = 12) 
