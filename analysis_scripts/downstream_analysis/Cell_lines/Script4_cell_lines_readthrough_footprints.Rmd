...
```{r, echo=F, message=F}
write.table(complete_fottprint_df, "/SSD/maa7095/RIBOseq/Shino_new_analysis/inframe_downtream_analysis/Cell_lines/footprints/Footprint_raw_sum_counts.csv", quote = F, sep = ",")
...
write.csv(fraction_RIBO_df3, "/SSD/maa7095/RIBOseq/Shino_new_analysis/inframe_downtream_analysis/Cell_lines/footprints/Footprint_5_3_RIBO_NoSe.csv")
```
...
write.csv(fraction_RIBO_df3, "/SSD/maa7095/RIBOseq/Shino_new_analysis/inframe_downtream_analysis/Cell_lines/footprints/Footprint_5_3_RIBO_SeSuppl.csv")
