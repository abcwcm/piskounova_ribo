...
feature_1 <- read.csv("/SSD/maa7095/RIBOseq/PDX_RNA_analysis_2024/DE_PDX_RNA/CDS_RNA_counts_not_strand.txt", sep = "\t")
feature_2 <- read.csv("/SSD/maa7095/RIBOseq/PDX_RNA_analysis_2024/DE_PDX_RNA/subset_CDS_RNA_counts_not_strand_xeno.txt", sep = "\t")
